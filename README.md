...
- scripts/ci/test-coverage-delta.sh — Heuristic test adjacency & missing test delta detection
- scripts/ci/legacy-hotspot-detector.sh — Composite heuristic legacy/refactor hotspot scoring
- scripts/ci/review-scope.sh — Orchestrator producing consolidated artifacts (review_artifacts/)
...
By default subtitle artifacts (_.srt, _.vtt) are ignored via .gitignore.
