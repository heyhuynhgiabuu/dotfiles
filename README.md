...
- **Neovim (NvChad v2.0):** Custom Lua configs, plugin management, and productivity enhancements.
- **Zsh:** Advanced completions, aliases, environment variables, and plugin management with Zinit.
